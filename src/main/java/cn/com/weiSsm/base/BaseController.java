 ...
 */
package cn.com.weiSsm.base;

import cn.com.weiSsm.utils.*;
...
public abstract class BaseController {
	...
	protected String renderString(HttpServletResponse response, String string) {
		try {
			...
			response.setHeader("Access-Control-Allow-Origin", Global.getConfig("Access-Control-Allow-Origin"));
	...
	protected void initBinder(WebDataBinder binder) {
		...
		binder.registerCustomEditor(String.class, new PropertyEditorSupport() {
			...
			public void setAsText(String text) {
                text = ContentSafeFilter.filter(StringEscapeUtils.unescapeHtml4(text)); // 危险字符过滤
