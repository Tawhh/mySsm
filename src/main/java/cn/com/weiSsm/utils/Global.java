...
public class Global {
     ...
     * 日志对象
     */
    protected static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(Global.class);
    /**
     * 当前对象实例
     */
    ...
    public static String getProjectPath(){
        ...
        try {
            ...
            logger.info("error getProjectPath.IOException",e);
//			e.printStackTrace();
        }
        return projectPath;
    }
    ...
    public static void modifyConfig(String key, String value) {
        try {
            ...
            logger.info(" modifyConfig error Exception,写入properties信息",e);
//			e.printStackTrace();
        }
    }
